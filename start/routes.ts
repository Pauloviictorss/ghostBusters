...
Route.resource('/equipamento', 'EquipamentosController').apiOnly()
Route.resource('/aluguel', 'AluguelEquipamentosController').apiOnly()
Route.resource('/preferencias', 'PreferenciasController').apiOnly()
